...
blob_fixups: blob_fixups_user_type = {
    ...
    'system_ext/lib64/libwfdservice.so': blob_fixup()
        .replace_needed('android.media.audio.common.types-V2-cpp.so', 
    ...
    'vendor/lib/libstagefright_soft_ac4dec.so': blob_fixup()
        .replace_needed('libstagefright_foundation.so', 
    ...
    ('vendor/lib64/libMIAIHDRhvx_interface.so', 'vendor/lib64/libarcsoft_hdrplus_hvx_stub.so', 'vendor/lib64/libarcsoft_super_night_raw.so'): blob_fixup()
